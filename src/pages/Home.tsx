        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-700 mb-8 max-w-2xl mx-auto animate-fade-in-delay-2">
              Our proven SEO system gets Detroit businesses to the top of Google search results. If we don't get you on the first page of Google for your target keywords within 90 days, you get a full refund. Guaranteed.
            </p>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-orange-50 mb-6 leading-relaxed">
              We're so confident in our SEO system that we offer this guarantee: If we don't get your business on the first page of Google for your target keywords within 90 days, you get every penny back. No questions asked.
            </p>
